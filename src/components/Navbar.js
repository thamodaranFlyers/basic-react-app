...
function Navbar({perms}) {

    console.log("in Navbar component ...");
    console.log("got these perms", {perms});
    ...
    return (
        <nav class="flex items-center justify-between flex-wrap bg-teal-500 p-6">
            ...
            <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                ...
                { hasOrgPerm(perms,'view-projects') &&
                    <a href="/projects" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                        Projects
                    </a>
                }
                { hasOrgPerm(perms,'manage-users') &&
                    <a href="#responsive-header" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white mr-4">
                        Users
                    </a>
                }
                {hasOrgPerm(perms, 'support-plan') &&
                    <a href="/support" class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
                        Support
                    </a>
                }
                </div>
